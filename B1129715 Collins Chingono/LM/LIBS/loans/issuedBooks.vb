Public Class issuedBooks
    ...
    Private Sub txtReg_TextChanged(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub txtBookNumber_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub btnReturn_Click(sender As Object, e As EventArgs) Handles btnReturn.Click
        ...
        If OverLappedRentDays > 0 Then
            MessageBox.Show(book & " OverDue Book " & OverLappedRentDays & " days." & vbNewLine &
                    "You have exceeded maximum number of days with book, so you should pay fine.", "Library system", MessageBoxButtons.OK, MessageBoxIcon.Hand)
        ...
        ElseIf OverLappedRentDays <= 0 Then
            ...
            If issucess = True Then
                MsgBox("book has been returned successfully", MsgBoxStyle.Information)
                ...
                book_delete("DELETE From loan  Where isbn='" & txISNB.Text & "'")
            Else
                MsgBox("Book error while returning book please consult system Administrator", MsgBoxStyle.Critical)
            End If
        Else
        End If
    End Sub

    Private Sub txtBookNumber_TextChanged_1(sender As Object, e As EventArgs) Handles txtBookNumber.TextChanged
        Try
    ...
    Private Sub btnBnow_Click(sender As Object, e As EventArgs) Handles btnBnow.Click
        issucess = book_insert("UPDATE books SET status= 'Available' WHERE isbn='" & txISNB.Text & "'")
