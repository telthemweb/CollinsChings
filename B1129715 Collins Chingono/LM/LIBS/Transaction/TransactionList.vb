...
Public Class TransactionList
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PrintDocument1.PrintPage
        With GridTrans
            ...
            Dim text As String = ("Powered by: Glen Norah High 2")
            fmt.LineAlignment = StringAlignment.Center
            fmt.Trimming = StringTrimming.EllipsisCharacter
            e.Graphics.DrawString(text, New Font("Verdana", 15, FontStyle.Bold), Brushes.Black, 350, 30)
    ...
    Private Sub TransactionList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        bookfindthis("select DISTINCT(bookID) from tbtransaction")
        fillcombo(cmbBookcode, "bookID", "bookID")
    End Sub



    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        If cmbBookcode.SelectedIndex = True Then
            bookfindthis("SELECT ID,bookID,isbn,studentID,issuedate,dateReturned,dateAdded FROM tbtransaction WHERE bookID = '" & cmbBookcode.Text & "' Order by isbn ASC ")
